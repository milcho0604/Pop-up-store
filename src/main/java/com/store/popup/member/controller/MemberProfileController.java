...
public class MemberProfileController {
    ...
    @GetMapping("/me")
    public ResponseEntity<CommonResDto> getMyProfile() {
    ...
    // 특정 회원 프로필 공개 조회
    @GetMapping("/{memberId}")
    public ResponseEntity<CommonResDto> getProfileById(@PathVariable Long memberId) {
        MemberProfileResDto res = memberProfileService.getProfileById(memberId);
        CommonResDto commonResDto = new CommonResDto(HttpStatus.OK, "프로필 조회 성공", res);
        return new ResponseEntity<>(commonResDto, HttpStatus.OK);
    }
    ...
    @PostMapping("/me")
    public ResponseEntity<CommonResDto> updateMyProfile(@ModelAttribute MemberProfileUpdateReqDto dto) {
